...
my_canvas.create_text(450, 150, text="WELCOME TO THE ADDMISSON PLATFORM OF LOTUS INSTITUTE OF TECHNOLOGY", font=("times new roman", 16,BOLD,ITALIC), fill="orange")

my_canvas.create_text(440, 230, text="Click The Below Button To Continue...", font=("times new roman", 16,BOLD), fill="white")
...
btn5 = Button(window, text="CLICK HERE", width=12,bg="grey",fg="white",command=change_frame4,font=("times new roman",16,BOLD))
