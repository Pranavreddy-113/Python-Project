...
window.iconbitmap('c:/Users/prana/Downloads/universitylogo.ico')

frame1 = Frame(window,pady=140)
frame2 = Frame(window,padx=100,pady=200)
frame3 = Frame(window,padx=280,pady=240)
...
bg = PhotoImage(file="c:/Users/prana/Downloads/home.png")
...
def change_frame5():
    ...
    IMAGE_PATH = 'c:/Users/prana/Downloads/edit.png'
    ...
    button = tk.Button(window, text="Home", bg="grey", borderwidth=1, command = change_frame4)
    ...
    # my_canvas1 = Canvas(window, width=800, height=500)
    # my_canvas1.pack(fill="both", expand=True)
    # # Set image in canvas
    # my_canvas1.create_image(0,0, image=bg, anchor="nw")
    # my_canvas1.create_text(450, 170, text="WELCOME TO THE ADDMISSON PLATFORM OF LOTUS INSTITUTE OF TECHNOLOGY", font=("times new roman", 16,BOLD,ITALIC), fill="black")
...
main_logo.pack()
img= (Image.open("c:/Users/prana/Downloads/Univlogo.png"))
resized_image= img.resize((800,380), Image.ANTIALIAS)
...
Ephonel.grid(row=1,column=3)
passwordl.grid(row=2,column=1,sticky=tk.W)
Epasswordl.grid(row=2,column=3)

#Documents Buttons Submit(frame3)
btnfile0 = Button(frame3,text="",border=0, width=10,height=1)
...
btnfile1.grid(row=2,column=2,pady=10,padx=100)
btnfile2.grid(row=3,column=2,pady=10)
btnfile3.grid(row=4,column=2,pady=10)
btnfile4.grid(row=40,column=120,padx=100,pady=50)
...
#Top-Left Logo
click_btn= PhotoImage(file="c:/Users/prana/Downloads/Univlogo .png")
...
btn5 = Button(window, text="CLICK HERE",bg="grey",fg="black",command=change_frame4,width=12,borderwidth=1,font=("times new roman",16,BOLD))
btn5.place(x=375,y= 300)
